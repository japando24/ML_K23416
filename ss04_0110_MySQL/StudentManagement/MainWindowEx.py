#4.1 Coding kế thừa Ui_MainWindow, và định nghĩa các biến
import base64
import traceback
...
#4.2 Override phương thức setupUI
...
#4.3 Viết mã lệnh kết nối MySQL Server, cơ sở dữ liệu 'studentmanagement'
...
#4.4 Viết lệnh truy vấn toàn bộ Student và hiển thị lên QTableWidget
...
#4.5 Viết hàm hiển thị thông tin chi tiết student khi nhấn vào từng dòng dữ liệu trong QTableWidget
    def processItemSelection(self):
        ...
        try:
            ...
            cursor = self.conn.cursor()
            # query all students
            sql = "select * from studentmanagement.student where code=%s"
            val = (code,)
...
#4.6 Viết lệnh chọn Avatar và xóa Avatar, có tạo base64string
    def pickAvatar(self):
...
#4.10 Viết hàm xóa dữ liệu trên giao diện của phần chi tiết
    def clearData(self):
